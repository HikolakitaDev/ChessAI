...
bishop_eg = [
    ...
    -6,   3,  13,  12,  9,   5,  10,   1,
    -5,   2,  -2,  -2, -1,   2,   5,  -5,
    -20,  -13, -10,  -9, -6, -9, -15, -23,
]

rook_mg = [
    32,  42,  32,  51, 63,  9,  31,  43,
    27,  32,  58,  62, 80, 67,  26,  18,
...
def evaluate_board(board: chess.Board) -> int:
    ...
    tables = middlegame_tables if game_phase == "middlegame" or game_phase == "opening" else endgame_tables
    ...
    for piece_type, table in tables.items():
        ...
        for square in board.pieces(piece_type, chess.BLACK):
            ...
            positional_score -= table[mirrored_square]
